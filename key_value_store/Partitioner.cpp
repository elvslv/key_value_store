...
namespace key_value_store
{
    ...
    std::list<network::Address> Partitioner::getTargetNodes(const std::string& key, const std::vector<membership_protocol::Member>& members)
    {
        ...
        std::list<network::Address> result;
